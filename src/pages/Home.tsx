      ...
      <section className="space-y-16 relative">
        <div className="flex items-center gap-8">
          <div className="flex flex-col">
            ...
            <span className="text-[10px] font-serif text-red-500/60 mt-1 uppercase tracking-widest">Registros de Jornada</span>
          </div>
          <div className="h-px flex-1 bg-gradient-to-r from-white/20 via-red-600/20 to-transparent" />
        </div>
        
        <Suspense fallback={<div className="h-96 flex items-center justify-center">Carregando registros...</div>}>
          {allSortedMembers.length > 0 ? (
            ...
            <div className="py-20 text-center">
              <p className="text-white/20 uppercase font-black tracking-widest">Nenhum aventureiro encontrado nesta classe.</p>
            </div>
          )}
        </Suspense>
      </section>
